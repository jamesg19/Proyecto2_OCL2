...
var gramatica = (function() {
    var o = function(k, v, o, l) { for (o = o || {}, l = k.length; l--; o[k[l]] = v); return o },
        ...
        $V7 = [1, 10],
        $V8 = [1, 11],
        $V9 = [2, 5, 7, 12, 15, 16, 17, 21, 22, 23, 25, 29, 31],
        $Va = [1, 32],
        $Vb = [1, 35],
        $Vc = [1, 31],
        $Vd = [1, 33],
        ...
        $Vh = [8, 17, 36, 39, 40],
        $Vi = [1, 49],
        $Vj = [10, 11, 41, 48, 49, 50, 51],
        $Vk = [2, 34],
        $Vl = [1, 50],
        $Vm = [1, 51],
        $Vn = [1, 52],
        $Vo = [1, 53],
        $Vp = [10, 11, 20, 30, 36, 37, 38, 41, 44, 45, 46, 47, 48, 49, 50, 51],
        $Vq = [10, 11],
        $Vr = [10, 11, 20, 30, 36, 41, 44, 45, 46, 47, 48, 49, 50, 51],
        $Vs = [10, 11, 50, 51],
        $Vt = [1, 95],
        $Vu = [1, 96],
        $Vv = [15, 29, 31];
