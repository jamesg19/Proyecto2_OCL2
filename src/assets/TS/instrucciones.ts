...
const instruccionesAPI = {
	 ...
	 * @param {*} tipo 
	 */
	nuevoOperacionBinaria: function(operandoIzq: any, operandoDer: any, tipo: any) {
	 ...
	 * @param {*} tipo 
	 */
	nuevoOperacionUnaria: function(operando:any, tipo:any) {
	 ...
	 */
	nuevoImprimir: function(expresionCadena:any) {
		return {
	 ...
	 * @param {*} instrucciones 
	 */
	nuevoMientras: function(expresionLogica:any, instrucciones:any) {
		return {
	 ...
	 * @param {*} decremento
	 */
	nuevoPara: function (variable:any, valorVariable:any, expresionLogica:any, aumento:any, instrucciones:any) {
		return {
	 ...
	 * @param {*} identificador 
	 */
	nuevoDeclaracion: function(identificador:any, tipo:any) {
		return {
	 ...
	 */
	nuevoAsignacion: function(identificador:any, expresionNumerica:any) {
		return {
	 ...
	 */
	nuevoIfElse: function(expresionLogica:any, instruccionesIfVerdadero:any, instruccionesIfFalso:any) {
		return {
	 ...
	 * @param {*} caso 
	 */
	nuevoListaCasos: function (caso:any) {
		var casos = []; 
		casos.push(caso);
		return casos;
	},
	 ...
	 * @param {*} instrucciones 
	 */
	nuevoCaso: function(expresionNumerica:any, instrucciones:any) {
		return {
	 ...
	 * @param {*} instrucciones 
	 */
	nuevoCasoDef: function(instrucciones:any) {
		return {
	...
	*/
	 ...
	 * @param {*} expresionCadena 
	 */
	nuevoAsignacionSimplificada: function(identificador:any, operador:any , expresionNumerica:any){
		return{
