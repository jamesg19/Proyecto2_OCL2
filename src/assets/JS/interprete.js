...
const TIPO_OPERACION = require('./src/assets/JS/instrucciones.js').TIPO_OPERACION;
const TIPO_VALOR = require('./src/assets/JS/instrucciones.js').TIPO_VALOR;
const instruccionesAPI = require('./src/assets/JS/instrucciones.js').instruccionesAPI;
const TIPO_OPCION_SWITCH = require('./src/assets/JS/instrucciones.js').TIPO_OPCION_SWITCH
