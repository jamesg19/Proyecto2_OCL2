...
%{
	const TIPO_OPERACION	= require('.src/assets/JS/instrucciones').TIPO_OPERACION;
	const TIPO_VALOR 		= require('.src/assets/JS/instrucciones').TIPO_VALOR;
	const TIPO_DATO			= require('.src/assets/JS/instrucciones').TIPO_DATO; //para jalar el tipo de dato
	const instruccionesAPI	= require('.src/assets/JS/instrucciones').instruccionesAPI;
%}
